  ...
  <DefaultLayout>
    <v-container>
      <v-row>
        ...
        <!--          >-->
        <!--            <template #default>-->
        <!--              <v-card-title>Get Featured?</v-card-title>-->
        <!--              <v-card-text>-->
        <!--                Send photos of your fun adventures to katrina@katalystranch.com or tag us on instagram!-->
        <!--              </v-card-text>-->
        <!--              <v-img-->
        <!--                aspect-ratio="1"-->
        <!--                max-height="175px"-->
        <!--                src="https://i.imgur.com/LAf5YiV.png"-->
        <!--              />-->
        <!--            </template>-->
        <!--          </v-img>-->
        <!--        </v-col>-->
